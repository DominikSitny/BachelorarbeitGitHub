...
Die digitale Transformation von Geschäftsprozessen stellt Unternehmen vor die Herausforderung, bestehende Arbeitsweisen mit modernen Technologien zu verbinden. Insbesondere im Bereich des Projektcontrollings existieren häufig gewachsene Strukturen, die auf Microsoft Excel und SharePoint basieren. Die vorliegende Arbeit untersucht, wie eine Middleware-Architektur gestaltet werden kann, die sowohl bestehende Excel-basierte Workflows unterstützt als auch einen schrittweisen Übergang zu service-orientierten Architekturen ermöglicht.
