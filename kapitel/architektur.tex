...
Die Middleware folgt einer Schichtenarchitektur mit klarer Trennung der Verantwortlichkeiten \citep{fowler2002}:
...
Das Datenmodell orientiert sich an den Excel-Strukturen und wird in \gls{cds} definiert. Es folgt den Prinzipien des Domain-Driven Design \citep{evans2003, vernon2013} und bildet die Domänenkonzepte des Budget-Controllings ab.
...
Die folgenden Sequenzdiagramme veranschaulichen die wichtigsten Abläufe in der Middleware.
...
\textbf{Trade-off}: Bei Server-Neustart gehen Sessions verloren. Benutzer müssen sich neu einloggen. Für einen Prototyp akzeptabel, für Produktion sollte Redis verwendet werden.
...
\textbf{Trade-off}: GraphQL wäre flexibler bei komplexen Abfragen, aber der Mehraufwand ist für diesen Use Case nicht gerechtfertigt.
