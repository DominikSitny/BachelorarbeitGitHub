...
In der BC Middleware wird das Repository-Pattern konzeptionell mit dem Adapter-Pattern kombiniert: Die \texttt{loadData()}-Funktion übernimmt die Rolle des Repositories und delegiert den tatsächlichen Datenzugriff an den jeweiligen Adapter. Die Service-Schicht ruft ausschließlich \texttt{loadData()} auf und erhält ein einheitliches Datenobjekt, unabhängig davon, ob der Excel-Adapter oder ein zukünftiger OData-Adapter die Daten liefert.
